...
export const __goAdapterCheck = {
  ...
  createUpstream: createUpstreamFromProvider({ name: "OpenAI", provider: "openai", protocol: "openai-chat", base_url: "https://api.openai.com/v1", api_key: "sk" } satisfies CreateProvider),

...
// backend (go/llm/spec/protocols.json). Neither side reads it at runtime: this
// test and go/llm/spec/contract_test.go each assert their own table matches it,
...
describe("protocol identity contract (llm/spec/protocols.json)", () => {

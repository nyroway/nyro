...
// # Layer and ownership
//
// Layer: 0 (foundation). This tree is internal to Nyro. It imports only the
// standard library and its own spec, ir, and codec packages; it must not depend
// on providers, storage, transports, or other application packages.
//

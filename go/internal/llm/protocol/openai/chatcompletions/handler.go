...
func (ingress) Endpoint() protocol.Endpoint { return protocol.OpenAIChatCompletionsV1 }
func (ingress) Capabilities() protocol.Capabilities {
	return protocol.Capabilities{
		IngressRoutes:    []protocol.IngressRoute{{Method: "POST", Pattern: "/v1/chat/completions"}},
		Streaming:        true,
...
func (egress) Endpoint() protocol.Endpoint { return protocol.OpenAIChatCompletionsV1 }

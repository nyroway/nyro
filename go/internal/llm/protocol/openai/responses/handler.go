...
func (ingress) Endpoint() protocol.Endpoint { return protocol.OpenAIResponsesV1 }
func (ingress) Capabilities() protocol.Capabilities {
	return protocol.Capabilities{
		IngressRoutes: []protocol.IngressRoute{{Method: "POST", Pattern: "/v1/responses"}},
		Streaming:     true,
	}
}
...
func (egress) Endpoint() protocol.Endpoint         { return protocol.OpenAIResponsesV1 }

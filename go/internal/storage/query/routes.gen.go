...
func newRoute(db *gorm.DB, opts ...gen.DOOption) route {
	...
	_route.Model = field.NewString(tableName, "model")
	_route.Balance = field.NewString(tableName, "balance")
	_route.EnableAuth = field.NewBool(tableName, "enable_auth")
	_route.EnablePayload = field.NewBool(tableName, "enable_payload")
	_route.Enabled = field.NewBool(tableName, "enabled")
	_route.CreatedAt = field.NewString(tableName, "created_at")
	_route.UpdatedAt = field.NewString(tableName, "updated_at")
...
type route struct {
	...
	EnableAuth    field.Bool
	EnablePayload field.Bool
	Enabled       field.Bool
...
func (r *route) updateTableName(table string) *route {
	...
	r.Balance = field.NewString(table, "balance")
	r.EnableAuth = field.NewBool(table, "enable_auth")
	r.EnablePayload = field.NewBool(table, "enable_payload")
...
func (r *route) fillFieldMap() {
	...
	r.fieldMap["enable_auth"] = r.EnableAuth
	r.fieldMap["enable_payload"] = r.EnablePayload
